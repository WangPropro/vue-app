<template>
	<navigator class="goods-item":url="`/pages/goods/goods-detail/goods-detail?id=${item.id}`">
		...
		<view class="u-flex u-row-between ">
			<view class="price u-skeleton-rect">积分{{item.price}}</view>
