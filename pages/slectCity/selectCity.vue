		...
		<view class="header w100 flexw" :style="{height:customBar}">
			...
			<view class="flex w100">
				<input class="input" :focus="true" @confirm="doneInput" type="text" confirm-type="search"
					:adjust-position="false" @input="onInput" placeholder="搜索城市 中文/拼音/首字母" v-model="searchValue" />
			...
			<view v-if="disdingwei" id="hot">
				...
				<view class="dingwei" v-if="cacheLocation">
					...
					<view class="dingwei_city dingwei_city_zuijin">
						<view class="dingwei_city_one" v-for="(item,index) in cacheLocation" :key="index"
							@tap="back_city(item)">
							{{item.city_name}}
						</view>
					</view>
				...
				<view class="dingwei" v-if="hotCity">
					...
					<view class="dingwei_city dingwei_city_zuijin">
						<view class="dingwei_city_one" v-for="(item,index) in hotCity" :key="index"
							@tap="back_city(item)">
							{{item.city_name}}
						</view>
					</view>
