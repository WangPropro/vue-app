				...
				<view class="one_box">
					...
					<view class="top3">
						<view class="num_two">
							...
							<view class="top_sy">成都·18000<span>积分</span></view>
						</view>
					</view>
					...
					<view class="top3">
						<view class="num_one">
							...
							<view class="top_name text-bold" style="font-size: 30rpx;">王 * 奶</view>
							<view class="top_sy">北京·18000<span>积分</span></view>
						</view>
					</view>
					...
					<view class="top3">
						<view class="num_three">
							...
							<view class="top_name">李 * 奶</view>
							<view class="top_sy">西安·17500<span>积分</span></view>
						</view>
					</view>
				</view>
			...
			<view class="rankList_box">
				<view class="rankItem" v-for="(item,index) in rankList" :key="index">
					...
					<view class="NameBox">
						...
						<view class="color_ccc">{{item.city}} ｜ <text class="text-blue">{{item.salary}}</text>积分</view>
					</view>
