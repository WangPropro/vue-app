<template>
	<view class="about">
		...
		<div class="step">
			...
			<div class="left" v-show="leftPercent"
				:class="[{ 'full-left': !rightPercent }, { 'tringle': rightPercent }]"
				:style="{ width: leftPercent+'%' }" @mouseover="onMouseTooltip(LEFT_BAR, SHOW_TIP)"
			...
			<div class="right" v-show="rightPercent" :class="[{ 'full-right': !leftPercent }]"
				@mouseover="onMouseTooltip(RIGHT_BAR, SHOW_TIP)" @mouseleave="onMouseTooltip(RIGHT_BAR, HIDE_TIP)">
